    ...
    (function(){
        ...
        <ul>
            <li class="<?= ($current_page == 'parent_dashboard.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>parent/parent_dashboard.php"><i class="fa-solid fa-gauge-high"></i><span>Dashboard</span></a>
            </li>
        </ul>
        <hr>
        <h3>Your Children</h3>
        <ul>
            <li class="<?= ($current_page == 'parent_activity.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>parent/parent_activity.php"><i class="fa-solid fa-chart-line"></i><span>Activity &amp; Progress</span></a>
            </li>
            <li class="<?= ($current_page == 'parent_programs.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>parent/parent_programs.php"><i class="fa-solid fa-graduation-cap"></i><span>Learning Programs</span></a>
            </li>
            <li class="<?= ($current_page == 'parent_payments.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>parent/parent_payments.php"><i class="fa-solid fa-receipt"></i><span>Payment History</span></a>
            </li>
            <li class="<?= ($current_page == 'parent_orders.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>parent/parent_orders.php"><i class="fa-solid fa-box-open"></i><span>Orders</span></a>
            </li>
            <li>
                <a href="<?= $base ?>parent/parent_dashboard.php?open=create_child"><i class="fa-solid fa-child"></i><span>Create Child Account</span></a>
            </li>
        </ul>
        <hr>
        <h3>General</h3>
