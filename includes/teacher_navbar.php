    ...
    (function(){
        ...
        <ul>
            <li class="<?= ($current_page == 'teacher_dashboard.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_dashboard.php"><i class="fa-solid fa-gauge-high"></i><span>Dashboard</span></a>
            </li>
        </ul>
        <hr>
        <h3>Classroom</h3>
        <ul>
            <li class="<?= ($current_page == 'teacher_live_classes.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_live_classes.php"><i class="fa-solid fa-satellite-dish"></i><span>Live Classes</span></a>
            </li>
            <li class="<?= ($current_page == 'teacher_program_videos.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_program_videos.php"><i class="fa-solid fa-clapperboard"></i><span>Program Videos</span></a>
            </li>
            <li class="<?= ($current_page == 'teacher_quizzes.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_quizzes.php"><i class="fa-solid fa-circle-question"></i><span>Quizzes</span></a>
            </li>
            <li class="<?= ($current_page == 'teacher_quiz_results.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_quiz_results.php"><i class="fa-solid fa-chart-simple"></i><span>Quiz Results</span></a>
            </li>
        </ul>
        <hr>
        <h3>Shopping</h3>
        <ul>
            <li class="<?= ($current_page == 'teacher_orders.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_orders.php"><i class="fa-solid fa-receipt"></i><span>My Orders</span></a>
            </li>
        </ul>
        <hr>
        <h3>General</h3>
