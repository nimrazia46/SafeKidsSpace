...
$sks_sidebar_open = isset($_COOKIE['sksSidebarOpen_main']) && $_COOKIE['sksSidebarOpen_main'] === 'true';
...
<div id="sk-navbar">
  ...
  <?php 
                        ...
                        <?php endif; ?>
                        <?php if ($user_role === 'student' || $user_role === 'child'): ?>
                            <a href="<?= $base ?>store/my_orders.php" class="yt-dropdown-item-link">
    ...
    (function(){
        ...
        <ul>
            <li class="<?= ($current_page == 'index.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>index.php"><i class="fa-solid fa-house"></i><span>Home</span></a>
            </li>
            <li class="<?= ($current_page == 'videos.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>videos.php"><i class="fa-solid fa-video"></i><span>Videos</span></a>
            </li>
            <li class="<?= in_array($current_page, ['games.php','wordgame.php','taceletter.php','arcade.php']) ? 'active' : ''; ?>">
                <a href="<?= $base ?>games/games.php"><i class="fa-solid fa-gamepad"></i><span>GAMES</span></a>
            </li>
        </ul>
        <hr>
        <h3>Explore</h3>
        <ul>
            <li class="<?= ($current_page == 'learning.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>learning.php"><i class="fa-solid fa-brain"></i><span>Learning Zone</span></a>
            </li>
            <li class="<?= ($current_page == 'quiz.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>quiz/quiz.php"><i class="fa-solid fa-question"></i><span>Quiz</span></a>
            </li>
            <li class="<?= ($current_page == 'library.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>library/library.php"><i class="fa-solid fa-book-open"></i></i><span>library</span></a>
            </li>
            <li class="<?= ($current_page == 'store.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>store/store.php"><i class="fa-solid fa-store"></i><span>Kids Store</span></a>
            </li>
        </ul>
        <hr>
        <h3>More from SafeKids Space</h3>
        <ul>
            <li class="<?= ($current_page == 'parent_dashboard.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>parent/parent_dashboard.php"><i class="fa-solid fa-user-group"></i><span>For Parents</span></a>
            </li>
            <li class="<?= ($current_page == 'teacher_dashboard.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>teacher/teacher_dashboard.php"><i class="fa-solid fa-chalkboard-user"></i><span>For Teachers</span></a>
            </li>
             <li class="<?= ($current_page == 'qa.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>qa/qa.php"><i class="fa-solid fa-circle-question"></i><span>Faq</span></a>
            </li>
            <li class="<?= ($current_page == 'about.php') ? 'active' : ''; ?>">
                <a href="<?= $base ?>about.php"><i class="fa-solid fa-circle-info"></i><span>About Us</span></a>
            </li>
        </ul>
    </aside>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    if(menu && sidebar){
        menu.addEventListener('click', (e) => {
            ...
            if(window.innerWidth <= 768){
                ...
                document.cookie = 'sksSidebarOpen_main=' + isOpen + '; path=/; max-age=31536000; SameSite=Lax';
            }
    ...
    if (sksSearchInput && sksSearchClearBtn) {
        ...
        sksToggleClearBtn(); // run once on load in case a query is already in the box (e.g. on the search results page)
